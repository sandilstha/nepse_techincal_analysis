...
## Corpus Check
- 79 files · ~99,650 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2146 nodes · 5317 edges · 135 communities (83 shown, 52 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 194 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a7ff18bd`
...
- `AdminApprovalTests` --uses--> `NepseMarketIndex`  [INFERRED]
...
Cohesion: 0.06
Nodes (83): backfill_missing_company_profiles(), Command, Safety-net backfill for the company list.  The dropdown reads from ``CompanyProf, Create CompanyProfile rows for recently-traded symbols that have none.      Retu, _build_url(), _can_stop_after_ascending_page(), _clean_date(), _clean_decimal() (+75 more)
...
Cohesion: 0.50
Nodes (4): broker_flow_radar(), broker_names(), Map of broker number (str) -> firm name, from the nepse_brokers table.      Ke, Broker-wide flow ranking for the full market.      This extends a basic "Top B
...
Cohesion: 0.06
Nodes (16): _(), ae(), ce(), ct, de(), dt(), fe(), In() (+8 more)
...
Cohesion: 0.10
Nodes (9): Cn, cs, gs(), ks(), ls(), ms(), Ss(), ws (+1 more)

### Community 13 - "Community 13"
Cohesion: 0.24
Nodes (18): _asset_version(), broker_concentration_api(), broker_favorites_api(), broker_flow_radar_api(), broker_meta_api(), broker_persistence_api(), broker_signals_api(), floorsheet_view() (+10 more)
...
Cohesion: 0.29
Nodes (16): el(), fmtNum(), fmtPct(), fmtRs000(), fmtValue(), load(), loadFromInput(), periodLabel() (+8 more)

### Community 29 - "Community 29"
Cohesion: 0.12
Nodes (24): _aggregate_day(), _build_meta(), _cached_day_value(), _company_meta(), _company_names(), _day_has_rows(), _fallback_brokers(), get_day_aggregate() (+16 more)
...
Cohesion: 0.31
Nodes (5): AdvancedMarketStructureTests, InstitutionalAnalysisTests, generate_dummy_ohlcv(), MarketStructureConfig, run_advanced_market_structure_analysis()
...
Cohesion: 0.13
Nodes (19): fundamental_analysis_view(), _fundamental_tickers(), Distinct tickers that actually have fundamentals, with company names., Render the Fundamental Analysis desk shell.      The symbol is only the initial, _asset_version(), _empty_payload(), market_insights_api(), market_insights_view() (+11 more)
...
Cohesion: 0.10
Nodes (28): _build_benchmark_sparkline(), build_dashboard_context(), _build_index_dataframes(), _build_standard_dataframe(), _canonical_market_index_symbol(), crud_dashboard_view(), _dashboard_asset_version(), dashboard_tab_calc() (+20 more)
...
Cohesion: 0.15
Nodes (8): BaseCommand, Command, grant_staff — give (or revoke) a My Portfolio account access to the Workbench., _clean(), Command, load_brokers — seed / refresh the ``nepse_brokers`` reference table from the bun, Broker, Table: nepse_brokers     Reference list of NEPSE stock brokers (and stock deale
...
Cohesion: 0.15
Nodes (16): _custom_trading_dates(), _fiscal_year_start(), get_custom_range_aggregate(), get_range_aggregate(), _local_trading_dates(), _merge_into(), Nepali fiscal-year start (≈ Shrawan 1) on or before ``latest_date``., List of trading-day strings for a range, newest first (incl. latest). (+8 more)
...
Cohesion: 0.09
Nodes (12): AccountApproval, Admin review state for a self-service portfolio account request., BrokerFlowRadarTests, IMMScoringTests, IndicatorHistoryWindowTests, make_price_frame(), MarketInsightsHeadlineTests, MSVStrategyTests (+4 more)
...
- **Why does `_()` connect `Community 7` to `Community 129`, `Community 2`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 15`, `Community 16`, `Community 20`, `Community 22`, `Community 23`, `Community 27`, `Community 28`, `Community 33`, `Community 37`, `Community 38`, `Community 43`, `Community 44`, `Community 45`, `Community 47`, `Community 48`, `Community 51`, `Community 52`, `Community 54`, `Community 55`, `Community 56`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 70`, `Community 73`, `Community 75`, `Community 87`, `Community 88`, `Community 89`, `Community 94`, `Community 107`, `Community 109`, `Community 110`, `Community 112`, `Community 119`, `Community 120`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.161) - this node is a cross-community bridge._
- **Why does `vn` connect `Community 89` to `Community 129`, `Community 7`, `Community 10`, `Community 11`, `Community 15`, `Community 16`, `Community 20`, `Community 23`, `Community 25`, `Community 27`, `Community 28`, `Community 36`, `Community 37`, `Community 39`, `Community 44`, `Community 45`, `Community 47`, `Community 48`, `Community 51`, `Community 60`, `Community 64`, `Community 66`, `Community 72`, `Community 84`, `Community 108`, `Community 110`, `Community 112`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `run_support_resistance_analysis()` connect `Community 1` to `Community 34`, `Community 124`, `Community 53`?**
