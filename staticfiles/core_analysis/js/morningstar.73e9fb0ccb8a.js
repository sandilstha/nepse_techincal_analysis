...
(function () {
  ...
  function scatterSvg(pts, compact) {
    ...
    [
      { n: "I",   x: X(97), y: Y(97), a: "end",   cap: "Growth + cheap",   tip: "Above-median growth AND above-median value — the sweet spot" },
      { n: "II",  x: X(3),  y: Y(97), a: "start", cap: "Cheap, slow",      tip: "Cheap but below-median growth — deep value or value trap" },
      { n: "III", x: X(3),  y: Y(6),  a: "start", cap: "Slow + expensive", tip: "Below-median growth and expensive — avoid zone" },
      { n: "IV",  x: X(97), y: Y(6),  a: "end",   cap: "Growing, pricey",  tip: "Growing faster than peers but expensively priced — already discovered" }
    ].forEach(function (q) {
